...
If local mode does not return a result, try a narrower query with a statute number such as `RA 9003`, `RA 10173`, `RA 11058`, `RA 7160`, `RA 10121`, `RA 10667`, `RA 11765`, `RA 11934`, or `RA 11976`. The local corpus is intentionally bounded and does not search live government sites.
