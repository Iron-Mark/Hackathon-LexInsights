...
- Draft warnings for thin environmental impact, ECC, wildlife, tree-cutting, timber, forest-land, watershed, tourism, hospitality, guest safety, travel-service, aviation, maritime, port, cargo-handling, seafarer credential, and seafarer-welfare controls.
