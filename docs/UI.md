...
- Tailwind CSS is configured through the Next.js app styles in [globals.css](../lexiph/src/app/globals.css).
- Shared UI primitives live in [components/ui](../lexiph/src/components/ui).
...
- Chat routes share [chat-page-shell.tsx](../lexiph/src/components/chat/chat-page-shell.tsx).
