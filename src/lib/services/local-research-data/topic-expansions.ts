...
export const TOPIC_EXPANSIONS: LocalTopicExpansion[] = [
  ...
  },
  {
    ...
    expansions: [
      ...
      'operator of payment system',
      'bsp payment system supervision',
  ...
  },
  {
    ...
    expansions: [
      ...
      'fuel dealer and distributor controls',
      'doe market monitoring',
      'consumer fuel complaint',
    ],
  },
  {
    triggers: [
    ...
    expansions: [
      ...
      'lpg cylinder traceability',
      'lpg refilling safety',
      'lpg dealer controls',
      'consumer lpg complaint',
    ],
  },
  {
    triggers: [
    ...
    expansions: [
      'biofuels act',
      'biofuel blend compliance',
      'bioethanol',
      'biodiesel',
      'fuel quality records',
      'consumer fuel disclosure',
    ],
  },
  {
    triggers: [
