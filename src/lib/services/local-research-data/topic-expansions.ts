...
export const TOPIC_EXPANSIONS: LocalTopicExpansion[] = [
  ...
  },
  {
    ...
    expansions: [
      'sec memorandum circular 15 2025',
      'sec memorandum circular 1 2021',
      'beneficial ownership transparency',
      'ultimate beneficial owner',
      'direct owner indirect owner nominee control',
      'harbor beneficial ownership registry',
      'gis reportorial filing',
      'corporate secretary authorized filer',
      'privacy safeguards',
      'amla customer due diligence relationship',
    ],
  },
  {
  ...
  {
    triggers: ['saln', 'code of conduct', 'ethical standards', 'gift', 'public official', 'financial interest', 'public trust', 'divestment', 'family interest'],
    expansions: ['code of conduct and ethical standards', 'saln', 'gift rules', 'conflict disclosure', 'recusal', 'records custody', 'redaction'],
  },
  {
    triggers: [
      'coa',
  ...
  {
    triggers: ['plunder', 'ill gotten wealth', 'misappropriation', 'conversion', 'commission', 'aggregate amount', 'series of transactions', 'asset forfeiture'],
    expansions: ['plunder act', 'ill gotten wealth', 'public funds', 'kickbacks', 'asset preservation', 'chain of custody', 'criminal referral'],
  },
  {
  ...
  },
  {
    ...
    expansions: [
      ...
      'unused invoice inventory',
      'authority to print serial number',
      'certificate of registration',
      'taxpayer classification',
      'micro taxpayer small taxpayer',
      'tax refund',
  ...
  {
    triggers: ['philsys', 'philid', 'national id', 'psn', 'pcn', 'identity verification', 'biometric', 'proof of identity'],
    expansions: [
  ...
  {
    triggers: ['public records', 'records management', 'records retention', 'archives', 'document disposal', 'retention schedule', 'records inventory', 'records disposition', 'records custodian'],
    expansions: ['national archives act', 'records officer', 'records custodian', 'retention schedule', 'access classification', 'preservation', 'authorized disposal'],
  },
  {
    triggers: ['foi', 'freedom of information', 'information request', 'public disclosure', 'transparency', 'redaction', 'efoi', 'foi manual', 'request denial', 'exceptions inventory'],
    expansions: ['freedom of information executive order', 'request intake', 'receiving office', 'response timeline', 'exceptions', 'redaction', 'written denial', 'appeal route'],
  },
  {
