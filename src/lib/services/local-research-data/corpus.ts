...
export const LEGAL_CORPUS: LocalLegalDocument[] = [
  ...
  },
  {
    ...
    lastVerified: '2026-06-26',
    sourceNotes:
      'Official Lawphil text of the SIM Registration Act; verify current NTC, DICT, NPC, telco, and law-enforcement request procedures before operational use.',
    aliases: [
      'ra 11934',
      'republic act 11934',
      'sim registration act',
      'sim card registration',
      'subscriber identity module registration',
      'subscriber registration',
      'mobile number registration',
    ],
    topics: ['telecommunications', 'sim registration', 'identity verification', 'subscriber data', 'privacy', 'fraud prevention'],
    keywords: [
      'sim',
    ...
    obligations: [
      ...
      'Separate ordinary account support, correction, reactivation, and complaint handling from law-enforcement disclosure, subpoena, warrant, or authorized-request handling.',
      'Include fraud-reporting, text-scam response, retention, access controls, breach coordination, user assistance, and audit logs.',
  ...
  {
    id: 'ntc-mc-001-12-2022-sim-irr',
    statute: 'NTC Memorandum Circular No. 001-12-2022',
    title: 'Implementing Rules and Regulations of the SIM Registration Act',
    shortTitle: 'SIM Registration Act IRR',
    year: 2022,
    sourceName: 'Supreme Court E-Library',
    sourceUrl: 'https://elibrary.judiciary.gov.ph/thebookshelf/showdocs/10/98949',
    authorityType: 'regulation',
    sourceTier: 'official-guidance',
    lastVerified: '2026-06-26',
    sourceNotes:
      'Official Supreme Court E-Library copy of the SIM Registration Act IRR; verify current NTC, DICT, NPC, PTE, and law-enforcement request procedures before relying on operational details.',
    aliases: [
      'ntc mc 001-12-2022',
      'ntc memorandum circular 001-12-2022',
      'sim registration act irr',
      'implementing rules and regulations of the sim registration act',
      'sim registration irr',
      'ra 11934 irr',
    ],
    topics: ['telecommunications', 'sim registration', 'subscriber data', 'identity verification', 'privacy', 'lawful disclosure'],
    keywords: [
      'sim registration',
      'public telecommunications entity',
      'pte',
    ...
    summary:
      'Implementation guidance for SIM registration workflows, including public telecommunications entity duties, registration-data handling, verification, deactivation and reactivation, confidentiality, and lawful disclosure routes.',
    obligations: [
      'For telco, OTP, mobile-number, or fraud-report workflows, map subscriber intake, identity-document verification, correction, deactivation, reactivation, complaint handling, and PTE accountability.',
      'Protect registration data with confidentiality, access control, audit logs, breach coordination, and purpose-limited handling.',
      'Separate subscriber support from authorized disclosure to law enforcement, courts, or agencies, and retain evidence of each lawful request.',
      'Check special cases such as minors, juridical entities, foreigners, lost or stolen SIMs, and transfer or change-of-information requests.',
    ],
    commonGaps: [
      'SIM registration procedures do not say who verifies identity documents or handles correction and reactivation requests.',
      'Subscriber-data disclosure is allowed without subpoena, court order, written lawful request, or audit trail.',
      'Fraud-reporting, lost-SIM, deactivation, and breach procedures are not separated from ordinary customer support.',
    ],
  },
  {
    id: 'ra-9995',
  ...
  },
  {
    ...
    lastVerified: '2026-06-26',
    sourceNotes:
      'Official Lawphil text of the Philippine Identification System Act; verify current PSA, PhilSys, agency authentication, data-sharing, and service-delivery procedures before operational use.',
    aliases: ['ra 11055', 'republic act 11055', 'philippine identification system act', 'philsys', 'national id', 'philid', 'philippine national id'],
    topics: ['identity', 'national id', 'philsys', 'personal data', 'biometrics', 'government services', 'authentication'],
    keywords: [
      'philid',
      'psn',
      'pcn',
    ...
    obligations: [
      ...
      'Include correction, assistance, alternative proof, service access, audit logs, relying-party accountability, and authorized disclosure controls.',
