        ...
        <>
          ...
          {error && (
            <Card className="p-4 border-red-200 bg-red-50">
              ...
              <p className="font-body text-red-700 mt-2" aria-live="polite">{error}</p>
            </Card>
          )}
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {response.provider_mode && (
                    <div>
                      ...
                      <span className="inline-block px-2.5 py-1 rounded text-xs font-medium bg-emerald-100 text-emerald-800 border border-emerald-200">
