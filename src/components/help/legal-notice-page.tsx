  ...
  return (
    <main className="min-h-dvh bg-[linear-gradient(180deg,#f7f6ff_0%,#ffffff_54%,#f8fafc_100%)] px-4 py-6 text-slate-950 dark:bg-[linear-gradient(180deg,#211a35_0%,#171322_55%,#120d1f_100%)] dark:text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-8 grid gap-6 border-b border-slate-200 pb-8 dark:border-iris-300/15 lg:grid-cols-[1fr_14rem]">
          <div className="flex items-start gap-4">
            <div className="mt-1 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-iris-100 text-iris-700 dark:bg-iris-400/15 dark:text-iris-200">
          ...
          <nav
            className="border-l border-slate-200 pl-4 text-sm dark:border-iris-300/15"
            aria-label="Legal notice sections"
          >
            <p className="text-xs font-bold uppercase text-slate-500 dark:text-slate-400">Sections</p>
