    ...
    return (
      <div className="flex flex-1 flex-col px-4 py-5">
        <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-iris-50 text-iris-700">
              <MessageSquarePlus className="h-5 w-5" aria-hidden="true" />
            </div>
            <div className="min-w-0 text-left">
              <p className="text-sm font-semibold text-slate-950">No chats yet</p>
          ...
          <button
            ...
            className="mt-4 flex min-h-10 w-full items-center justify-center gap-2 rounded-lg bg-iris-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition-all hover:bg-iris-700 hover:shadow-md active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-iris-600"
            type="button"
          >
            {isCreatingChat ? (
        ...
        <div className="mt-4 rounded-lg border border-dashed border-slate-200 px-4 py-3 text-left">
          <p className="text-[11px] font-semibold uppercase text-slate-400">Chat history</p>
          <p className="mt-1 text-xs leading-5 text-slate-500">
