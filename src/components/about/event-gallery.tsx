...
type GalleryImage = {
  src: string
  /** Objective description of the frame for screen readers. */
  alt: string
  /** Short human caption shown under the image in the lightbox. */
  caption: string
}

// CodeKada 2025 (2025-11-08) event photos, ordered chronologically.
